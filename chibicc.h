...
bool can_direct_8bit_store_ext(Node *rhs);
bool gen_direct_8bit_store_ext(Node *rhs, char *opb);
bool gen_direct_8bit_ext(Node *rhs, char *opb);
...
bool can_direct_8bit_store_ix(Node *rhs);
bool gen_direct_8bit_store_ix(Node *rhs, char *opb);
bool can_direct_8bit_ext_ix(Node *rhs);
bool gen_direct_8bit_ext_ix(Node *rhs, char *opb);
bool can_direct_8bit_store_ext_ix(Node *rhs);
...
extern bool opt_fbuiltin_isnan;
extern bool opt_fbuiltin_isinf;
