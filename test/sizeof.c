...
int main() {
  ...
  ASSERT(4, sizeof(long int));
  ASSERT(4, sizeof(long int));
  ASSERT(2, sizeof(char *));
  ASSERT(2, sizeof(int *));
  ASSERT(2, sizeof(long *));
  ASSERT(2, sizeof(int **));
  ASSERT(2, sizeof(int(*)[4]));
  ASSERT(8, sizeof(int*[4]));
  ASSERT(8, sizeof(int[4]));
  ASSERT(24, sizeof(int[3][4]));
  ASSERT(4, sizeof(struct {int a; int b;}));
...
//ASSERT(8, sizeof(unsigned long long int));
  ...
  ASSERT(2, sizeof((int)1));
  ASSERT(4, sizeof((long)1));

  ASSERT(2, sizeof((char)1 + (char)1));
  ASSERT(2, sizeof((short)1 + (short)1));
  ASSERT(2, sizeof(1?2:3));
  ASSERT(2, sizeof(1?(short)2:(char)3));
  ASSERT(4, sizeof(1?(long)2:(char)3));
